...
AS (i_id INTEGER, quantity INTEGER);
...
CREATE OR REPLACE FUNCTION new_order_body (INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, new_order_info, new_order_info, new_order_info, new_order_info, new_order_info, new_order_info, new_order_info, new_order_info, new_order_info, new_order_info, new_order_info, new_order_info, new_order_info, new_order_info, new_order_info)
RETURNS SETOF stock_info
AS 'MODULE_PATHNAME'
LANGUAGE C STRICT;
